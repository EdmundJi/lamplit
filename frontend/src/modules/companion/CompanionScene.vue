...
<style scoped>
.companion-scene { position: relative; width: 100%; overflow: hidden; border: 1px solid #d4dac7; border-radius:var(--radius-scene); background: #e9e9d8; }
...
.resident-status { position: relative; display: inline-flex; align-items: center; justify-content: center; min-width: 32px; min-height: 30px; box-sizing: border-box; padding: 3px 5px; border: 2px solid #75786b; border-radius:var(--radius); background: #fff5df; font-size: 16px; line-height: 1; box-shadow: inset 0 -2px #e5d9bc, 2px 2px #43513c30; }
...
.resident-card { position: absolute; z-index: 3; bottom: calc(100% + 5px); left: 50%; transform: translateX(-50%); display: grid; grid-template-columns: auto auto; align-items: baseline; gap: 4px 9px; width: max-content; max-width: 160px; padding: 9px 11px; background: #fff9edf5; border: 1px solid #dedcc8; border-radius:var(--radius-card); color: #46573f; box-shadow: 0 4px 12px #2b42241a; white-space: normal; text-align: left; pointer-events: none; }
...
.resident-person { width: 36px; border-radius:var(--radius-card); }
.resident-person:focus-visible { outline: 2px solid #f0dfac; border-radius:var(--radius-card); }
...
.resident-dialogue { display: flex; flex-direction: column; gap: 9px; width: 236px; max-width: 236px; max-height: 190px; overflow-y: auto; pointer-events: auto; cursor: pointer; background: #fff8e9; border: 2px solid #858976; border-radius:var(--radius); box-shadow: inset 0 -2px #e9ddc2, 3px 3px #43513c24; }
...
.companion-scene__roster button { border: 1px solid #cfd6bf; border-radius:var(--radius-panel); padding: 5px 10px; background: #f3f3e6; color: #5c6855; font-size: 11px; cursor: pointer; }
