...
.emoji-item { min-width: 0; aspect-ratio: 1; display: grid; place-items: center; padding: 4px; border: 0; border-radius: var(--radius-card); background: transparent; cursor: pointer; }
