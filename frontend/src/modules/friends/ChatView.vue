...
<template>
  ...
  <section class="page page--talk chat-page">
    ...
    <div ref="listElement" class="message-list" aria-live="polite">
      ...
      <EmptyState v-else sprite="duck_brown_idle_1" title="还没有消息" description="打个招呼，开始这段同行。" />
    </div>
...
.chat-avatar { width: 58px; height: 58px; display: grid; place-items: center; border-radius: 19px 19px 19px 6px; background: linear-gradient(145deg, var(--primary), color-mix(in srgb, var(--primary) 72%, var(--amber))); color: white; font-size: 24px; font-weight: 900; }
