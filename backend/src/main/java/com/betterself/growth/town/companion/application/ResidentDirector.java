...
public class ResidentDirector {
    ...
    ResidentMind.Context perspective(CompanionWorld w,String residentId,Instant now,List<Turn> transcript){
        ...
        // "谁在用什么" (docs/04-decisions.md 2026-09-14): derived, never a second copy of occupancy/
        // activity/holding that could drift from the structure those already are - see
        // ResidentSimulation.positionUses's own doc comment.
        var positionUses=ResidentSimulation.positionUses(w,r.id,now);
