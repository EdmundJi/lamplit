...
class RoutingResidentMindTest {
    ...
    @Test void enabledOnlyWhenTheGeneralProviderIsQwenAndTheTownToggleIsOn() {
        ...
        assertThat(new RoutingResidentMind(mind, mind, "qwen", true, "deepseek", "deepseek", "deepseek").enabled()).isTrue();
        assertThat(new RoutingResidentMind(mind, mind, "mock", true, "deepseek", "deepseek", "deepseek").enabled()).isFalse();
