...
class RoutingResidentMindTest {
    ...
    @Test void enabledOnlyWhenTheGeneralProviderIsQwenAndTheTownToggleIsOn() {
        ...
        assertThat(new RoutingResidentMind(mind, mind, "qwen", true, "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek").enabled()).isTrue();
        assertThat(new RoutingResidentMind(mind, mind, "mock", true, "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek").enabled()).isFalse();
        assertThat(new RoutingResidentMind(mind, mind, "qwen", false, "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek", "deepseek").enabled()).isFalse();
    }
    ...
    private static RoutingResidentMind routing(QwenResidentMind deepseek, QwenResidentMind qwen, String decisionRoute, String turnRoute, String summaryRoute) {
        return new RoutingResidentMind(deepseek, qwen, "qwen", true, decisionRoute, turnRoute, summaryRoute, decisionRoute, decisionRoute, decisionRoute, decisionRoute, decisionRoute, decisionRoute);
    }
